...
namespace WineCardAppVersionFour.Migrations
{
    ...
    [Migration("20240904103731_M zu n migration")]
    partial class Mzunmigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WineCardAppVersionFour.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AccountId = 1,
                            HashPassword = "$2a$11$okkUCnPF3D4a9lJjFr2RqeP7HU7ucMbnMJfr87DOurTjU1EWsOU7O",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("WineCardAppVersionFour.Entities.WineCard", b =>
                {
                    b.HasOne("WineCardAppVersionFour.Entities.Wine", "Wine")
                        .WithMany("WineCards")
